...
class AgentStateSchema(BaseModel):
    ...
    loop_step: int = 0
    final_report: str = ""
    credit_decision: Literal["PENDING", "APPROVED", "REJECTED", "REVISION_REQUIRED"] = "PENDING"
...
class ThreadStatusResponse(BaseModel):
    ...
    status: Literal["running", "interrupted", "completed", "failed"] = Field(..., description="Sürecin genel durumu")
